...
namespace WebApp.Controllers
{
    ...
    {
        public void SetAuthenticationToken(string name, bool isPersistant, Customer userData)
        {
            string data = null;
            if (userData != null)
        ...
        public Customer GetUserData()
        {
            ...
            try
            {
                ...
                if (cookie != null)
                {
                    ...
                    userData = new JavaScriptSerializer().Deserialize(ticket.UserData, typeof(Customer)) as Customer;
                }
            }
            catch (Exception ex)
            {
